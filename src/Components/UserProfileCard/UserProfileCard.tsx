...
const UserProfileCard = ({
  ...
  return (
    <section className="flex flex-col items-center gap-11 px-10 py-6 max-w-80 h-auto bg-gray-light shadow-custom-border rounded-md dark:bg-secondary dark:shadow-custom-border-white">
      <img
        src={avatarUrl}
        alt={`${username} avatar`}
